...
def should_trade(trades, last_trades):         
    last_mv = last_trades[-1]["mv"] 
    last_mv_ref = last_trades[-1]["mv_ref"]
    last_cost = last_trades[-1]["mv_ref"]

    current_price = trades[-1]["price_open"]
