...
class Config:
    ...
    SERVICE_INTERNAL_URL = os.getenv("PORTAL_PUBLIC_URL")

    SERVICE_BIND_HOST_INTERNAL = os.getenv("SERVICE_BIND_HOST_INTERNAL")
    SERVICE_BIND_HOST_EXTERNAL = os.getenv("SERVICE_BIND_HOST_EXTERNAL")
