...
start /B "" cmd /c "cd /d %ROOT_PATH%\Mixwell\services\AIService && python aiService.py %AI_SERVICE_PORT%"

echo --- Start Cam Service 8002 ---
start /B "" cmd /c "cd /d %ROOT_PATH%\Mixwell\services\CAMService && python camService.py %CMD_SERVICE_PORT%"

echo --- Start Video Service 8003 ---
start /B "" cmd /c "cd /d %ROOT_PATH%\Mixwell\services\VideoService && python videoService.py %VIDEO_SERVICE_PORT%"

echo --- Start Email Service 8004 ---
start /B "" cmd /c "cd /d %ROOT_PATH%\Mixwell\services\EmailService && python emailService.py %EMAIL_SERVICE_PORT%"

echo --- Start Travel Service 8005 ---
start /B "" cmd /c "cd /d %ROOT_PATH%\Mixwell\services\TravelService && python travelService.py %TRAVEL_SERVICE_PORT%"

echo --- Start Data API Service 8006 ---
start /B "" cmd /c "cd /d %ROOT_PATH%\Mixwell\services\DataAPIService && python dataAPIService.py %DATAAPI_SERVICE_PORT%"

echo --- Start RDP Service 8007 ---
start /B "" cmd /c "cd /d %ROOT_PATH%\Mixwell\services\RDPService && python rdpService.py %RDP_SERVICE_PORT%"

echo --- Start REGISTRY Service 8008 ---
start /B "" cmd /c "cd /d %ROOT_PATH%\Mixwell\services\RegistryService && python registryService.py %REGISTRY_SERVICE_PORT%"

REM echo --- Start Portal ---
start /B "" cmd /c "cd /d %ROOT_PATH%\Mixwell\portal && python app.py %PORTAL_PORT%"
