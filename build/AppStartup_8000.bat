...
C:\Workarea\MixwellSoftware.com-Services\build\MixwellSoftware.com-Services\mixwell-platform\venv\Scripts\python.exe C:\Workarea\MixwellSoftware.com-Services\build\MixwellSoftware.com-Services\mixwell-platform\portal\app.py 8000

REM FOR /D %%D IN (%SERVICES_DIR%\*) DO (call :StartService "%%~fD" "%%~nxD")
